...
state_file = open("demo2_wt.csv", "w")
str_state = []
...
angle1, angle2, angle3, torque1, torque2, torque3 = read_file('demo2_inSteps.csv')
...
for value in angle1:
    ...
    coeff1[count], pcov1[count] = curve_fit(eval_poly, np.linspace(0,spline,len(value)),value)
    count = count + 1
...
for value1 in angle2:
    coeff2[count1], pcov2[count1] = curve_fit(eval_poly, np.linspace(0,spline,len(value1)),value1)
    count1 = count1 + 1
...
for value2 in angle3:
    coeff3[count2], pcov3[count2] = curve_fit(eval_poly, np.linspace(0,spline,len(value2)),value2)
    count2 = count2 + 1
...
for value3 in torque1:
    coeff4[count3], pcov4[count3] = curve_fit(eval_poly, np.linspace(0,spline,len(value3)),value3)
    count3 = count3 + 1
...
for value4 in torque2:
    coeff5[count4], pcov5[count4] = curve_fit(eval_poly, np.linspace(0,spline,len(value4)),value4)
    count4 = count4 + 1
...
for value5 in torque3:
    coeff6[count5], pcov6[count5] = curve_fit(eval_poly, np.linspace(0,spline,len(value5)),value5)
    count5 = count5 + 1
...
#         while (time.time()-time_current1) <= 0.5:
#             if condition == True:
#                 temp = time.time()
#             else:
#                 pass
